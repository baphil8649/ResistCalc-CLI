...
This project was challenging and educational and a big part of it's success was finding and using the [JCommander](http://jcommander.org/) library by Cédric Beust.
